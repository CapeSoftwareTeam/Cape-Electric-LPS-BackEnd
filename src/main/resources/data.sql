        ...
        -----------> LPS EARTHING-TABLE <----------	  
           	...
           	CREATE TABLE EARTHING_LPS_DESCRIPTION(
				...
				CREATE TABLE EARTHINGCLAMPS_TABLE(
							...
							LOCATION_NUMBER INT,
                            LOCATION_NAME VARCHAR(225),
							PSYSICAL_INSPECTIONINOB VARCHAR(225),
				...
				CREATE TABLE EARTHELECTRODECHAMBER_TABLE(
							...
							LOCATION_NUMBER INT,
                            LOCATION_NAME VARCHAR(225),
							PSYSICAL_INSPECTIONOB VARCHAR(225),
							PSYSICAL_INSPECTIONREM VARCHAR(225),
							...
							EARTH_ELECTRODEBURIEDOB VARCHAR(225),
							EARTH_ELECTRODEBURIEDREM VARCHAR(225),
