...
-----------> LPS <----------
	...
	-----------> LPS AIR-TERMINALS <----------	
        ...
        CREATE TABLE EARTHSTUDS_TABLE(
			            EARTHSTUDS_ID INT AUTO_INCREMENT,
			            BASIC_LPS_ID INT,
			            USER_NAME VARCHAR(225),
			            EARTHSTUD_VISIBILITYOB VARCHAR(225),
			            EARTHSTUD_VISIBILITYREM VARCHAR(225),
			            EARTHSTUD_BEND_OB VARCHAR(225),
			            EARTHSTUD_BEND_REM VARCHAR(225),
			            PROPERBONDING_RAIL_OB VARCHAR(225),
			            PROPERBONDING_RAIL_REM VARCHAR(225),
			            PHYSICALDAMAGE_STUD_OB VARCHAR(225),
			            PHYSICALDAMAGE_STUD_REM VARCHAR(225),
			            CONTINUTYEXISTS_EARTH_OB VARCHAR(225),
			            CONTINUTYEXISTS_EARTH_REM VARCHAR(225),
			            CREATED_BY VARCHAR(255),
						CREATED_DATE datetime,
					    UPDATED_BY VARCHAR(255),
					    UPDATED_DATE datetime,
			           CONSTRAINT PK_EARTHSTUDS_ID PRIMARY KEY(EARTHSTUDS_ID)
           );