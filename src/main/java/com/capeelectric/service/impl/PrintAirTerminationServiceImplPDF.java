...
//			    for reference to chaild class only
				...
				List<VerticalAirTerminationList> VerticleAirTerminationL = lpsVerticalAirTermination1.getVerticalAirTerminationList();
...
//				cell23.setBackgroundColor(new GrayColor(0.93f));
				...
				for ( AirBasicDescription airBasicDesciption : airBasicDesc ) {
...
//				cell32.setBackgroundColor(new GrayColor(0.93f));
				...
				if (lpsAirTermination1.getVerticalAirTerminationAvailabilityOb().equalsIgnoreCase("applicable")) {
					...
					for ( LpsVerticalAirTermination lpsVerticalAirTermination : lpsVerticalAirTerm ) {
...
//				cell73.setBackgroundColor(new GrayColor(0.93f));
				...
				if (lpsAirTermination1.getAirMeshDescriptionAvailabilityOb().equalsIgnoreCase("applicable")) {
					...
					for (AirMeshDescription airMeshDescription : airMeshDesc) {
						...
						cell76.setPhrase(new Phrase(
								"Physical inspection (damage/break/bend/corroded/routing w.r.t design)", font1A));
						...
						cell87.setPhrase(new Phrase(
								"Maximum distance between mesh conductors(in x direction) in meters", font1A));
						...
						cell90.setPhrase(new Phrase(
								"Minimum distance between mesh conductors (in x direction) in meters", font1A));
						...
						cell93.setPhrase(new Phrase(
								"Maximum distance between mesh conductors(in y direction) in meters", font1A));
						...
						cell96.setPhrase(new Phrase(
								"Minimum distance between mesh conductors (in y direction) in meters", font1A));
...
//				cell104.setBackgroundColor(new GrayColor(0.93f));
				...
				for (AirHolderDescription airholders : airHolderdesc) {
...
//				Font font1A = new Font(BaseFont.createFont(), 10, Font.NORMAL, BaseColor.BLACK);
				...
				if (lpsAirTermination1.getAirClampsAvailabilityOb().equalsIgnoreCase("applicable")) {
					...
					for (AirClamps airClamps : airCla) {
						...
						PdfPCell cell107 = new PdfPCell();
						cell107.setPhrase(new Phrase(
								"Conductor clamp is firmly fixed/mounted/pasted over the flat surface", font1A));
						cell107.setHorizontalAlignment(Element.ALIGN_LEFT);
						cell107.setBackgroundColor(new GrayColor(0.93f));
						...
						cell116.setPhrase(new Phrase(
								"Material of wall clamp (to fix the conductor with wall / Parapet)", font1A));
...
//				Font font1A = new Font(BaseFont.createFont(), 10, Font.NORMAL, BaseColor.BLACK);
				...
				if (lpsAirTermination1.getAirExpansionAvailabilityOb().equalsIgnoreCase("applicable")) {
					...
					for (AirExpansion airExpansion : airExpan) {
...
//				Font font1A = new Font(BaseFont.createFont(), 10, Font.NORMAL, BaseColor.BLACK);
				...
				for (AirConnectors airConnectors : airConn) {
