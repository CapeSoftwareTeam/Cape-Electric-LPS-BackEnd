...
//				EarthingSystem earthSystem = earthSystem1.get(0);
				...
				for (EarthingSystem earthSystem : earthSystem1) {
					...
					PdfPTable table205 = typeBearthingSystem(font, earthSystem);
	...
	private PdfPTable typeBearthingSystem(Font font, EarthingSystem earthSystem) {
	...
	private PdfPTable earthingChamber(Font font11, Font font, EarthElectrodeChamber earthChamber) {
		...
		PdfPCell cell182 = new PdfPCell(new Paragraph("Maximum withstand load", font));
