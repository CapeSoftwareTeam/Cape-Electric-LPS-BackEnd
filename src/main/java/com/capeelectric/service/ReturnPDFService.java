...
//				Thread.sleep(5000);
				...
				fullObject = s3Client.getObject(new GetObjectRequest(s3BucketName,
						"LPS_Project Name_".concat(keyName) + "/" + keyName + ".pdf"));
	...
	public ByteArrayOutputStream printSummaryPDF(String userName, Integer lpsId, String projectName) throws Exception {
...
// Downloading the PDF File in AWS S3 Bucket with folderName + fileNameInS3
				S3Object fullObject;
				fullObject = s3Client.getObject(new GetObjectRequest(summaryBucketName,
